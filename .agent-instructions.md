...
Förslag till överordnat produktkontrakt finns i [docs/PRODUCT_CONTRACT.md](docs/PRODUCT_CONTRACT.md).
Det är ett granskningsutkast, inte ett antaget kontrakt eller en rapport om färdig funktion.
Källjämförelse och öppna beslut finns i [docs/PRODUCT_CONTRACT_REVIEW.md](docs/PRODUCT_CONTRACT_REVIEW.md);
elev–lärarscenarier och underlag för klassobservation finns i [docs/PRODUCT_SCENARIOS.md](docs/PRODUCT_SCENARIOS.md).
Nuvarande rangordning gäller tills Simon har fastställt förslaget.
