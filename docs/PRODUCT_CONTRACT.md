...
- **D3 — Lärarens ram respekteras.** Appen lämnar inte tyst ett uttryckligen låst innehåll eller en låst nivå. Om eleven fastnar fortsätter träningen inom ramen och läraren får en signal som visar de faktiska felsvaren; appen avbryter inte eleven automatiskt med stöd eller paus. Adaptiva uppdrag medger återhämtning inom angiven ram.
