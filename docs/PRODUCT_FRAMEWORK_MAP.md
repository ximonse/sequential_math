...
Status: **kartläggning v0.7, 2026-09-21; E1 kontrakterat, E2 lokalt implementerat och E3:s mastery-, återhämtnings- och supportflöden implementerade**.
...
| F2.1 Nästa träningsbeslut — P2/P3/P9, D1/D2 | Ett ansvar fattar nästa beslut från aktuellt behov inom F1. Historiskt belagt kunnande är separat. | `currentNeed`, `scopedSelection`, `adaptiveEngine`, `difficultyAdapter`, sessionsregler | Scoped urval läser nu ett versionsmärkt behov för befästande, utmaning, flerledad återhämtning och support. Start/warmup ägs ännu av äldre separata regler; förmågeskattningen finns parallellt kvar. | S2/S3/S4/S7: långa förlopp, långsamma rätt, ihållande fel och återkomst. |
| F2.2 Avancering och bekräftelse — P3/P7, D1 | Automatisk progression; eventuell gratulation efter belagt kunnande, utan elevval. | `adaptationDecision`, `addProblemResult`, `usePracticeCoreActions`, `ProgressionMilestoneOverlay` | Masteryövergången har nu en versionsmärkt ägare och ja/nej-flödet är borttaget. Start ligger ännu i ett annat beslutsställe och hör till F2.1/E3:s fortsättning. | S2/S7: nästa uppgifter och bekräftelse följer samma beslut, även efter omladdning. |
...
| E3 Ett adaptivt beslutsflöde — **tre snitt lokalt implementerade 2026-09-21** | Skilj historiskt kunnande från aktuellt behov. Masteryövergång, flerledad återhämtning och lärarsignal efter ihållande fel är nu versionsmärkta beslut. Elevens ja/nej-avancering är avvecklad och gratulation följer belagt kunnande. Ett gemensamt startbeslut återstår. | E2, P1 | E3 är klart först när start/warmup ingår och S1–S4/S7 täcker långsamma rätt, fortsatt fel och faktisk nästa uppgift genom hela beslutsmodellen. |
...
**Nästa avgränsade arbete: E3:s startbeslut.** Samla warmup/start i samma regelverk och avgör därefter den parallella förmågeskattningens roll. Gränsen till `support` är nu versionsmärkt: efter fyra återhämtningsobservationer utan stabilisering fortsätter eleven inom ramen och läraren får en signal med faktiska felsvar. Publicering kräver separat begäran.
