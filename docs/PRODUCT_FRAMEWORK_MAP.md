...
| E5 Innehåll och samlad kvalitetsgrind — **två kodsnitt lokalt implementerade 2026-09-21** | En körningsguardian kasserar nu kandidater med fel domän, kompetens, nivå, visning, svarstyp eller ogiltig evidens före visning och stoppar efter begränsade omförsök. Återläsningen skiljer dessutom kontraktsgiltiga masteryfakta från bevarad legacyhistorik. Oberoende facitkontroll, variationsgrind och samlad UI-/klassrumsverifiering återstår. | Börjar med motexempel i E1/E2, avslutas efter E3/E4; innehållsfel P0 | S1–S10 har daterat resultat och begränsningar. Tester/build samt relevanta browser-/iPad-flöden är kontrollerade. Ingen automatisk publicering. |
