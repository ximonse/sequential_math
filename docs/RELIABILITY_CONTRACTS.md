...
Den auktoritativa specifikationen finns i [ORGANISATION_OCH_INLOGGNING_KONTRAKT.md](ORGANISATION_OCH_INLOGGNING_KONTRAKT.md). Där definieras skol- och klassrelationer, rollernas behörighet, den icke-publika elevinloggningen via klasslänk och den körbara verifieringen av dessa gränser.
