...
- Completed locally: the legacy environment-password auth route, raw password header and accountless tokens were removed after confirming an account-based admin login exists.
