...
- Implement server-side teacher-session revocation. Tokens expire after 12 hours and live class ownership prevents access after a class change, but deleting a teacher account does not immediately invalidate its already issued signed token.
