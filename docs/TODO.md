...
### Next
- [x] Fri träning: strikt nivålåsning per global nivåsteg. Om någon vald domän har nivå 1 ofärdig ska inga nivå 2-uppgifter visas. Samma regel för 2->3 osv, med fortsatt rotation mellan domäner på samma nivå.
...
- [x] Lägg till ett högkontrastläge (utan nytt tema): samma visuella språk men tydligare kantlinjer, starkare kontraster och bättre läsbarhet för elever med svagare syn samt visning på avstånd.
