...
export function addProblemResult(profile, problem, studentAnswer, timeSpent, options = {}) {
  ...
  const result = {
    ...
    isKnowledgeError: errorCategory === 'knowledge' || errorCategory === 'misconception',
    ...
    varietyTemplate: String(problem.metadata?.varietyTemplate || ''),
    representation: String(problem.metadata?.representation || ''),
